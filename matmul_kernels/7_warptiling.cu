...
// https://stackoverflow.com/questions/41339994/using-cuda-vector-type-float-4-when-size-of-vector-is-not-divisible-by-4
...
matmulKernel_Warptiling(void *C, void *A, void* B, int M, int N, int K, int weight_quant_num){
